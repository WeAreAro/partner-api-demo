...
import { UnsecuredLoanFormStage, AddressStages, useStageStore, AddressPayloadSetters, FormType } from "@/app/state/stages";
        ...
        <><Head>
            ...
            }
            {
                formStage === UnsecuredLoanFormStage.SecondPreviousAddressStage && (
                    <AddressStage title={"Due to living at your current and previous address for under three years, you must provide your second to last address."} addressPayloadName={AddressStages.SECOND_PREVIOUS_ADDRESS}
            ...
            {
                formStage === UnsecuredLoanFormStage.BankDetailsStage && (
                    <BankDetailsStage />
                )
            }
            {
